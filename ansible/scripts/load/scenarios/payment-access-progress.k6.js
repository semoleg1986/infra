...
const scenarioPoolSize = Number(__ENV.LOAD_USER_POOL_SIZE || __ENV.K6_USER_POOL_SIZE || Math.max(vus, 5));
...
const paymentOfferId = __ENV.LOAD_PAYMENT_OFFER_ID || __ENV.K6_PAYMENT_OFFER_ID || '';
const learningEnabled = (__ENV.LOAD_LEARNING_ENABLED || __ENV.K6_LEARNING_ENABLED || '1') === '1';
const learningLesson1Id = __ENV.LOAD_LEARNING_LESSON1_ID || __ENV.K6_LEARNING_LESSON1_ID || '';
const learningLesson2Id = __ENV.LOAD_LEARNING_LESSON2_ID || __ENV.K6_LEARNING_LESSON2_ID || '';
const bonusEnabled = (__ENV.LOAD_BONUS_ENABLED || __ENV.K6_BONUS_ENABLED || '0') === '1';
const bonusAmount = Number(__ENV.LOAD_BONUS_AMOUNT || __ENV.K6_BONUS_AMOUNT || 30);
